...
async function aiRespond(prompt, context, file){
  ...
  const content=[{
    ...
    text:[
      ...
      'Cuando el usuario pida objeto, acta o informe, entrega texto listo para pegar en Word.',
      'Contexto SGRT (JSON): '+JSON.stringify(context||{}),
      'Solicitud: '+String(prompt||'')
    ].join('\n')
  }];
...
app.post('/api/ai/assist',async(req,res)=>{
  try{
    ...
    const body=req.body||{};
    const text=await aiRespond(body.prompt||'',body.context||{},body.file||null);
