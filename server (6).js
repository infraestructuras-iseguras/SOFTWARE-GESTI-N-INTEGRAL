...
// ✅ HEALTH CHECK — Azure lo necesita para health checks
...
// NO esperar a conectarDB en startup — hacerlo en background
// Esto permite que Azure health checks pasen
console.log('🔄 Intentando conectar a BD en background...');
conectarDB().then(() => {
  console.log('✅ BD conectada en background');
}).catch((err) => {
  console.warn('⚠️ BD no conectada aún, retry en 30s:', err.message);
  setTimeout(conectarDB, 30000);
});
