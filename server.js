...
function aiInstruction(prompt,context,history){
  ...
  return [
    ...
    'Si el usuario pide un video, prepara contenido audiovisual breve y claro: titulo, objetivo, escenas o secciones, texto visible y narracion sugerida. La interfaz puede convertir tu respuesta en un video visual.',
