...
(function(){
  ...
  function calcVal(r){
    ...
    r=r||{};var score={a1:.15,a2:.15,a3:.15,a4:.15,a5:.20,a6:.20},sum=0;
  ...
  if(typeof prevServer==='function')window.sgrtCargarDesdeServidor=async function(opts){var r=await prevServer.apply(this,arguments);if(!(opts&&opts.silentUi))setTimeout(finalizeUI,150);return r;};
