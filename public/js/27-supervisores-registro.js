...
(function(){
  ...
  function addSupervisor(out,s){
    if(!s)return;
    var item={
      nombre:text(s.nombre||s.Nombre||s.supervisor||s.SupervisorNombre),
      cargo:text(s.cargo||s.Cargo||s.supervisorCargo||s.CargoSupervisor),
      proceso:text(s.proceso||s.Proceso||s.procesoSupervision||s.proceso_supervision),
      contrato_asociado:text(s.contrato_asociado||s.contrato||s.numeroContrato||s.numContrato)
    };
  ...
  function normalizeThird(t){
    ...
    addSupervisor(out,{
      nombre:t.supervisor||t.SupervisorNombre,
      cargo:t.cargo||t.CargoSupervisor,
      proceso:t.procesoSupervision||t.proceso_supervision,
  ...
  function wrapGuardar(){
    ...
    var fn=async function(){
      ...
      var formSup={nombre:text((document.getElementById('cf-supervisor')||{}).value),cargo:text((document.getElementById('cf-cargo')||{}).value),proceso:text((document.getElementById('cf-proceso-supervision')||{}).value),contrato_asociado:text((document.getElementById('cf-nocontrato')||{}).value)};
