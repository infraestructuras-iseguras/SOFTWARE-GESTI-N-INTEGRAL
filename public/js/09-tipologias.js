...
window.guardarValoracionTipologias = function(){
  ...
  try{
    ...
    var _contrato2=contratoActual||'';
    // Quitar únicamente filas automáticas de ESTE contrato. Nunca borrar los
    // riesgos manuales ni la clasificación de los demás contratos.
    var _toRemove=MATRIZ_DB.filter(function(r){return r._origenClasificacion===true&&r.nit===_nit2&&String(r.contrato||'')===String(_contrato2);});
    ...
    _dims2.forEach(function(d,i){
      ...
      MATRIZ_DB.push({
        id:'R_'+_nit2+'_'+_contrato2+'_'+d.key+'_'+Date.now()+'_'+i,
        nit:_nit2, tercero:_nombre2, contrato:_contrato2,
        _origenClasificacion:true,
