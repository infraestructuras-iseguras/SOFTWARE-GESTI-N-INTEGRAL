...
(function(){
  ...
  function install(){
    ...
    if(!window._sgrtReportRealtimeTimer){window._sgrtReportRealtimeTimer=setInterval(function(){try{var pg=document.getElementById('pg-reportes-entidad');if(pg&&pg.offsetParent!==null)renderEnhancedReports();}catch(e){}},8000);}
