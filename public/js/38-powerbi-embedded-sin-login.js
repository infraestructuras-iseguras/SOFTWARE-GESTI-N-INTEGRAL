...
(function(){
  ...
  // Antes se observaba todo document.body, por lo que cada cambio del Evaluador
  // (incluido el cuestionario) despertaba innecesariamente el observador de Power BI.
  // Limitarlo al contenedor administrativo evita ese costo sin cambiar el embebido.
  try{var obsTarget=document.getElementById('admin-app');if(obsTarget)observer.observe(obsTarget,{childList:true,subtree:true});}catch(e){}
})();
