...
(function(){
  ...
  var LOCAL_MIGRATION='sgrt_inicio_limpio_sin_ibm_v3';
  var REMOTE_MIGRATION='sgrt_ibm_remoto_eliminado_v3';
  ...
  async function initialize(){
    // Mientras el DELETE remoto no haya terminado se limpia en cada apertura.
    // Así una copia antigua almacenada por el navegador no puede reinsertar IBM.
    if(localStorage.getItem(REMOTE_MIGRATION)!=='1' || localStorage.getItem(LOCAL_MIGRATION)!=='1')cleanLocalIBM();
    refresh();
