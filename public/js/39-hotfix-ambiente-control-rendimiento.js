 ...
 *    sincronización remota se agrupan (debounce) y los timers globales redundantes
 *    se espacian. No cambia backend, tablas, roles, diseño ni estructura de datos.
 */
(function(){
  'use strict';
  ...
  var persistTimer=null, remoteTimers={};
  ...
  function stashContract(nit){
    ...
    try{t.respuestasACPorContrato[c]=JSON.parse(JSON.stringify(getResponses()[nit]||{}));}catch(e){t.respuestasACPorContrato[c]=getResponses()[nit]||{};}
  ...
  document.addEventListener('click',function(ev){
    ...
    if(pg&&pg.classList.contains('active')) setTimeout(reconcileVisibleScores,120);
  },true);
