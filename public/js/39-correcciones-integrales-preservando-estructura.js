...
(function(){
  ...
  function updateStorageLabels(){
    var kb=0;try{kb=Math.round((localStorage.getItem('od_sgrt_v8')||'').length/1024);}catch(e){}
    var text='Metadatos locales: '+kb+' KB · archivos en repositorio';
  ...
  function init(){
    applyTextCorrections();hydrateRiskEvidence();installReportStorageBridge();
