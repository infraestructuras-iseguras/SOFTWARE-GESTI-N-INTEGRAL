...
document.addEventListener('DOMContentLoaded', function() {
  setTimeout(() => {
    // Producción: no insertar terceros de demostración de forma automática.
    // El seed solo puede ejecutarse si se habilita de manera explícita.
    if (window.SGRT_DISABLE_AUTO_DEMO !== false) {
      console.log('[DATOS] ℹ️ Precarga automática desactivada; se usarán únicamente registros reales.');
      return;
    }
