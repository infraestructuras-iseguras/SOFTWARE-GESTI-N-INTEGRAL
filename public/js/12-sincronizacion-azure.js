...
(function(){
  ...
  function remoteRecord(row){
    ...
    return {
      ...
      entidad:row.entidad||row.NombreEntidad||'colpensiones',
  ...
  function refresh(){
    ['clsRender','clsInitDash','loadIGTercerosFull','_isSuperAdminRefresh','sincronizarSelectorCuestionario','updateDashboard']
  ...
  window._lsPullFromAzure=async function(options){
    ...
    try{
      ...
      rows.forEach(function(row){
        ...
        next[nit]=Object.assign({},previous[nit]||{},remote);
      });
