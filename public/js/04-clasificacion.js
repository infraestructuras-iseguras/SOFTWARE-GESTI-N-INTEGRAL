      ...
      .then(d => {
        if(d.ok && d.data){
          ...
          window.TERCEROS_DB[nit] = {
            ...
            entidad: d.data.Entidad || '',
            supervisor: d.data.Supervisor || '',
            domicilio: d.data.Domicilio || '',
            prom: d.data.PromedioCalificacion || 0,
            zona: d.data.ZonaRiesgo || '',
            nivelRiesgo: d.data.NivelRiesgo || '',
            dimsPorContrato: clasificacionData.dimsPorContrato || {},
            promPorContrato: clasificacionData.promPorContrato || {},
