...
(function() {
  ...
  window.clsRender = function(){
    ...
    try {
      const localRaw = localStorage.getItem('sgrt_terceros_db_shared');
      const localDB = JSON.parse(localRaw || '{}');
      if(localRaw !== null && typeof TERCEROS_DB === 'object') {
        Object.keys(TERCEROS_DB).forEach(function(k){ delete TERCEROS_DB[k]; });
